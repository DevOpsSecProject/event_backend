  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new ticket" do
        expect {
          post ticket_url, params: valid_attributes, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new ticket" do
        expect {
          post ticket_url, params: invalid_attributes, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested ticket" do
        ticket = create(:ticket, user: user, event: event)
        patch ticket_url(ticket), params: new_attributes, as: :json
        ticket.reload
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the ticket" do
        ticket = create(:ticket, user: user, event: event)
        patch ticket_url(ticket), params: invalid_attributes, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to match(a_string_including("application/json"))
      end
    end
